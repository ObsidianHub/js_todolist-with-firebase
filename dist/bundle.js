...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"renderPost\", function() { return renderPost; });\nfunction renderPost(post) {\n  var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};\n  var tag = post.type === 'news' ? '<li class=\"tag tag-red tag-rounded\">Новость</li>' : '<li class=\"tag tag-blue tag-rounded\">Заметка</li>';\n  var favorites = JSON.parse(localStorage.getItem('favorites')) || [];\n  var candidate = favorites.find(function (p) {\n    return p.id === post.id;\n  });\n  var button = candidate ? \"<button data-id=\\\"\".concat(post.id, \"\\\" data-title=\\\"\").concat(post.title, \"\\\" class=\\\"button-round button-small button-danger\\\">\\u0418\\u0437 \\u0418\\u0437\\u0431\\u0440\\u0430\\u043D\\u043D\\u043E\\u0433\\u043E</button>\") : \"<button data-id=\\\"\".concat(post.id, \"\\\" data-title=\\\"\").concat(post.title, \"\\\" class=\\\"button-round button-small button-primary\\\">\\u0412 \\u0418\\u0437\\u0431\\u0440\\u0430\\u043D\\u043D\\u043E\\u0435</button>\");\n  return \"\\n        <div class=\\\"panel\\\">\\n            <div class=\\\"panel-head\\\">\\n                <p class=\\\"panel-title\\\">\".concat(post.title, \"</p>\\n                <ul class=\\\"tags\\\">\\n                    \").concat(tag, \"\\n                </ul>\\n            </div>\\n            <div class=\\\"panel-body\\\">\\n                <p class=\\\"multi-line\\\">\").concat(post.fulltext, \"</p>\\n            </div>\\n            <div class=\\\"panel-footer w-panel-footer\\\">\\n                <small>\").concat(post.date, \"</small>\\n                \").concat(options.withButton ? button : '', \"\\n            </div>\\n        </div>\\n    \");\n}\n\n//# sourceURL=webpack:///./src/templates/post.template.js?");
